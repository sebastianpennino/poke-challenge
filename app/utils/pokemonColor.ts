...
export const typeToBgClass = (type: PokemonType) => {
  switch (type) {
...
export const typeToTextClass = (type: PokemonType) => {
  switch (type) {
...
export const typeToAccentClass = (type: PokemonType) => {
  switch (type) {
...
export const typeToBorderClass = (type: PokemonType) => {
  switch (type) {
